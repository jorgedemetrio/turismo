...
class TurismoModelBomPara extends AdminModel
{
    ...
    public function getItems($data, $order = 'created DESC')
    {
        ...
        $query->select('b.id, b.nome, u.name AS creator_name, u2.name AS modifier_name, `ip_criador`, `ip_alterador`, `ip_proxy_criador`, `ip_proxy_alterador`, `publish`, `unpublish`')
